...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-fQybjgWLrvvRgtW6bFlB7jaZrFsaBXjsOMm/tB9LTS58ONXgqbR9W8oWht/amnpF" crossorigin="anonymous"></script>
    ...
    <nav class="navbar navbar-expand-lg" style="background-color: #F4EEB1;">
        ...
        <a class="navbar-brand" href="beranda_sistem.php">Beranda</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="cadangkan_pulihkan.php">Bekukan Akun</a>
            </li>
            <li class="nav-item">
    ...
    <table table class="table">
      ...
      ?>
          <tr align="center">
            ...
            <td><?php echo $d['no_hp']; ?></td>
            <td>
              <a href="bekukankonsumen.php?id=<?php echo $d['no_ktp']; ?>">BEKUKAN</a>
            </td>
          </tr>
          <?php 
            }
